// 客户端 Azure Speech 合成。与 web 版 server/src/services/azureTts.ts 用同一个
// SDK（microsoft-cognitiveservices-speech-sdk）、同样的 endpoint 与 mp3 输出格式，
// 在 WebView 内直接合成；音频以 object URL 形式返回，供 <audio> 播放。
//
